    ...
    highlights: [
      ...
      },
      {
        ...
        items: [
          ...
          '搭建公司内部导航平台，统一管理开发工具及多环境（正式/测试/资源）系统入口，提升团队访问效率',
          '基于 Next.js 构建前端架构，结合 Supabase 提供数据库与鉴权能力，实现导航配置管理、标签分类及权限控制',
          '实现 URL 参数解析工具，支持 query/path 参数拆解与可视化展示，提升开发调试效率',
          '基于 Vercel 完成部署与持续集成，降低运维成本，实现快速迭代上线',
        ],
      },
      {
        title: 'PWA SDK 与基础设施',
